...
//  PortfolioApp
//
//  Created by Chris Turner on 03/08/2024.
//
...
//        }
    ...
    init(inMemory: Bool = false) {
        ...
        // temporary, in-memory database by driting to dev/null
        // so our data is destroyed fter the app finishes running
        if inMemory {
    ...
    func hasEarned(award: Award) -> Bool {
        ...
        case "issues":
            // return true if added a certain number of issues
            let fetchRequest = Issue.fetchRequest()
            let awardCount = count(for: fetchRequest)
            return awardCount >= award.value

        case "closed":
            // return true if closed a certain number of issues
            let fetchRequest = Issue.fetchRequest()
        ...
        case "tags":
            // return true if created a certain number of tags
